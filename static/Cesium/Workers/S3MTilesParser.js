 ...
 */
define(['./when-a55a8a4c', './Check-bc1d37d9', './Math-edfe2d1c', './Cartesian2-f0158650', './BoundingSphere-02d3af5e', './RuntimeError-7c184ac0', './WebGLConstants-4c11ee5f', './ComponentDatatype-919a7463', './PrimitiveType-97893bc7', './FeatureDetection-bac17d71', './createTaskProcessorWorker', './BoundingRectangle-b42c500a', './Color-b1821df1', './pako_inflate-8ea163f9', './S3MCompressType-1baa0a0c'], function (when, Check, _Math, Cartesian2, BoundingSphere, RuntimeError, WebGLConstants, ComponentDatatype, PrimitiveType, FeatureDetection, createTaskProcessorWorker, BoundingRectangle, Color, pako_inflate, S3MCompressType) { 'use strict';
    ...
    function S3MTilesParser(parameters, transferableObjects) {
        ...
        for (var i = 0; i < pickColorCount; i++) {
            ...
            if (bInstanced == -1) {
                ...
                var beginOffset = instanceMode === 20 ? 16 : 31;
