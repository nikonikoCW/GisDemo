 ...
 */
define(['exports', './when-a55a8a4c', './Check-bc1d37d9', './Cartesian2-f0158650', './BoundingSphere-02d3af5e', './Transforms-a6232c91', './IntersectionTests-b4e5ec49', './Plane-a550aa8c'], function (exports, when, Check, Cartesian2, BoundingSphere, Transforms, IntersectionTests, Plane) { 'use strict';
    ...
    var scratchCart4 = new BoundingSphere.Cartesian4();
        /**
        ...
        function EllipsoidTangentPlane(origin, ellipsoid) {
            ...
            this._origin = origin;
            this._xAxis = Cartesian2.Cartesian3.fromCartesian4(BoundingSphere.Matrix4.getColumn(eastNorthUp, 0, scratchCart4));
            this._yAxis = Cartesian2.Cartesian3.fromCartesian4(BoundingSphere.Matrix4.getColumn(eastNorthUp, 1, scratchCart4));

            var normal = Cartesian2.Cartesian3.fromCartesian4(BoundingSphere.Matrix4.getColumn(eastNorthUp, 2, scratchCart4));
