 ...
 */
define(['./when-a55a8a4c', './createTaskProcessorWorker', './earcut-2.2.1-b404d9e6', './defined-21f7e510', './pbf-9fe59c76'], function (when, createTaskProcessorWorker, earcut2_2_1, defined, pbf) { 'use strict';
    ...
    FillBucket.prototype.addFeature = function addFeature(feature, geometry, index, imagePositions) {
        for (var i$4 = 0, list$2 = classifyRings(geometry, EARCUT_MAX_RINGS); i$4 < list$2.length; i$4 += 1) {
            ...
            var indices = earcut2_2_1.earcut(flattened, holeIndices);
    ...
    * };
    ...
    function MVTWorkTile(parameters, transferableObjects) {
        ...
        try {
            ...
            result = parse(vectorTile, styleIndexLayer, imageMap, featureIndex, zoom);
    ...
    function parse(vectorTile, layerIndex, imageMap, featureIndex, zoom) {
