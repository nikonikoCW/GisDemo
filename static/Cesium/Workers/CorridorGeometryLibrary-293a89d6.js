 ...
 */
define(['exports', './when-a55a8a4c', './Math-edfe2d1c', './Cartesian2-f0158650', './BoundingSphere-02d3af5e', './Transforms-a6232c91', './PolylineVolumeGeometryLibrary-588c1f1b', './PolylinePipeline-69e6af68'], function (exports, when, _Math, Cartesian2, BoundingSphere, Transforms, PolylineVolumeGeometryLibrary, PolylinePipeline) { 'use strict';
    ...
    /**
        ...
        function computeRoundCorner(cornerPoint, startPoint, endPoint, cornerType, leftIsOutside) {
            ...
            var m;
            if (leftIsOutside) {
                m = BoundingSphere.Matrix3.fromQuaternion(Transforms.Quaternion.fromAxisAngle(Cartesian2.Cartesian3.negate(cornerPoint, scratch1), angle / granularity, quaterion), rotMatrix);
            } else {
