 ...
 */
define(['./when-a55a8a4c', './Check-bc1d37d9', './GeometryOffsetAttribute-c9accdb9', './Math-edfe2d1c', './Cartesian2-f0158650', './BoundingSphere-02d3af5e', './RuntimeError-7c184ac0', './WebGLConstants-4c11ee5f', './ComponentDatatype-919a7463', './GeometryAttribute-de0e4f68', './PrimitiveType-97893bc7', './FeatureDetection-bac17d71', './Transforms-a6232c91', './GeometryAttributes-1c7ce91d', './VertexFormat-7f136973', './IndexDatatype-18a8cae6', './IntersectionTests-b4e5ec49', './Plane-a550aa8c', './arrayRemoveDuplicates-aafa59fd', './EllipsoidTangentPlane-0da38d24', './EllipsoidRhumbLine-ff66f54b', './earcut-2.2.1-b404d9e6', './PolygonPipeline-c1e5a14e', './PolylineVolumeGeometryLibrary-588c1f1b', './EllipsoidGeodesic-5bacea45', './PolylinePipeline-69e6af68', './CorridorGeometryLibrary-293a89d6'], function (when, Check, GeometryOffsetAttribute, _Math, Cartesian2, BoundingSphere, RuntimeError, WebGLConstants, ComponentDatatype, GeometryAttribute, PrimitiveType, FeatureDetection, Transforms, GeometryAttributes, VertexFormat, IndexDatatype, IntersectionTests, Plane, arrayRemoveDuplicates, EllipsoidTangentPlane, EllipsoidRhumbLine, earcut2_2_1, PolygonPipeline, PolylineVolumeGeometryLibrary, EllipsoidGeodesic, PolylinePipeline, CorridorGeometryLibrary) { 'use strict';
    ...
    var cartesian1 = new Cartesian2.Cartesian3();
        ...
        function addNormals(attr, normal, left, front, back, vertexFormat) {
            ...
            var forward = Cartesian2.Cartesian3.normalize(Cartesian2.Cartesian3.cross(left, normal, scratch1), scratch1);
        ...
        function combine(computedPositions, vertexFormat, ellipsoid) {
            ...
            if (addEndPositions) { // add rounded end
                ...
                for (i = 0; i < halfLength; i++) {
                    leftPos = Cartesian2.Cartesian3.fromArray(firstEndPositions, (halfLength - 1 - i) * 3, leftPos);
                    rightPos = Cartesian2.Cartesian3.fromArray(firstEndPositions, (halfLength + i) * 3, rightPos);
            ...
            for (i = 0; i < length; i += 3) {
                rightNormal = ellipsoid.geodeticSurfaceNormal(Cartesian2.Cartesian3.fromArray(rightEdge, i, scratch1), scratch1);
                leftNormal = ellipsoid.geodeticSurfaceNormal(Cartesian2.Cartesian3.fromArray(leftEdge, length - i, scratch2), scratch2);
                normal = Cartesian2.Cartesian3.normalize(Cartesian2.Cartesian3.add(rightNormal, leftNormal, normal), normal);
                addNormals(attr, normal, left, front, back, vertexFormat);
            ...
            rightNormal = ellipsoid.geodeticSurfaceNormal(Cartesian2.Cartesian3.fromArray(rightEdge, length, scratch1), scratch1);
            leftNormal = ellipsoid.geodeticSurfaceNormal(Cartesian2.Cartesian3.fromArray(leftEdge, length, scratch2), scratch2);
            normal = Cartesian2.Cartesian3.normalize(Cartesian2.Cartesian3.add(rightNormal, leftNormal, normal), normal);
            compIndex += 3;
            for (i = 0; i < corners.length; i++) {
                var j;
                ...
                if (when.defined(l)) {
                    ...
                    for (j = 0; j < l.length / 3; j++) {
                        ...
                        previousPoint = Cartesian2.Cartesian3.fromArray(finalPositions, (start - j - 1) * 3, previousPoint);
                        nextPoint = Cartesian2.Cartesian3.fromArray(finalPositions, pivot * 3, nextPoint);
                        left = Cartesian2.Cartesian3.normalize(Cartesian2.Cartesian3.subtract(previousPoint, nextPoint, left), left);
                        addNormals(attr, normal, left, undefined, back, vertexFormat);
                        back -= 3;
                    }
                    outsidePoint = Cartesian2.Cartesian3.fromArray(finalPositions, pivot * 3, outsidePoint);
                    previousPoint = Cartesian2.Cartesian3.subtract(Cartesian2.Cartesian3.fromArray(finalPositions, (start) * 3, previousPoint), outsidePoint, previousPoint);
                    nextPoint = Cartesian2.Cartesian3.subtract(Cartesian2.Cartesian3.fromArray(finalPositions, (start - j) * 3, nextPoint), outsidePoint, nextPoint);
                    left = Cartesian2.Cartesian3.normalize(Cartesian2.Cartesian3.add(previousPoint, nextPoint, left), left);
                    ...
                    for (j = 0; j < r.length / 3; j++) {
                        ...
                        previousPoint = Cartesian2.Cartesian3.fromArray(finalPositions, pivot * 3, previousPoint);
                        nextPoint = Cartesian2.Cartesian3.fromArray(finalPositions, (start + j) * 3, nextPoint);
                        left = Cartesian2.Cartesian3.normalize(Cartesian2.Cartesian3.subtract(previousPoint, nextPoint, left), left);
                        addNormals(attr, normal, left, front, undefined, vertexFormat);
                        front += 3;
                    }
                    outsidePoint = Cartesian2.Cartesian3.fromArray(finalPositions, pivot * 3, outsidePoint);
                    previousPoint = Cartesian2.Cartesian3.subtract(Cartesian2.Cartesian3.fromArray(finalPositions, (start + j) * 3, previousPoint), outsidePoint, previousPoint);
                    nextPoint = Cartesian2.Cartesian3.subtract(Cartesian2.Cartesian3.fromArray(finalPositions, start * 3, nextPoint), outsidePoint, nextPoint);
                    left = Cartesian2.Cartesian3.normalize(Cartesian2.Cartesian3.negate(Cartesian2.Cartesian3.add(nextPoint, previousPoint, left), left), left);
                    addNormals(attr, normal, left, undefined, back, vertexFormat);
                    back -= 3;
                }
                ...
                for (j = 0; j < leftEdge.length; j += 3) {
                    rightNormal = ellipsoid.geodeticSurfaceNormal(Cartesian2.Cartesian3.fromArray(rightEdge, j, scratch1), scratch1);
                    leftNormal = ellipsoid.geodeticSurfaceNormal(Cartesian2.Cartesian3.fromArray(leftEdge, length - j, scratch2), scratch2);
                    normal = Cartesian2.Cartesian3.normalize(Cartesian2.Cartesian3.add(rightNormal, leftNormal, normal), normal);
                    addNormals(attr, normal, left, front, back, vertexFormat);
            ...
            normal = Cartesian2.Cartesian3.fromArray(computedNormals, computedNormals.length - 3, normal);
            addNormals(attr, normal, left, front, back, vertexFormat);
            ...
            if (addEndPositions) { // add rounded end
                ...
                for (i = 0; i < halfLength; i++) {
                    leftPos = Cartesian2.Cartesian3.fromArray(lastEndPositions, (endPositionLength - i - 1) * 3, leftPos);
        ...
        function extrudedAttributes(attributes, vertexFormat) {
            ...
            if (vertexFormat.normal || vertexFormat.bitangent || vertexFormat.tangent) {
                ...
                for (i = 0; i < threeSize; i += 3) {
                    ...
                    bottomPosition   = Cartesian2.Cartesian3.fromArray(positions, i + threeSize, bottomPosition);
                    previousPosition = Cartesian2.Cartesian3.fromArray(positions, (i + 3) % threeSize, previousPosition);
                    bottomPosition   = Cartesian2.Cartesian3.subtract(bottomPosition,   topPosition, bottomPosition);
                    previousPosition = Cartesian2.Cartesian3.subtract(previousPosition, topPosition, previousPosition);
                    normal = Cartesian2.Cartesian3.normalize(Cartesian2.Cartesian3.cross(bottomPosition, previousPosition, normal), normal);
                    if (vertexFormat.normal) {
        ...
        function computeRectangle(positions, ellipsoid, width, cornerType, result) {
            ...
            if (cornerType === PolylineVolumeGeometryLibrary.CornerType.ROUNDED) {
                ...
                Cartesian2.Cartesian3.multiplyByScalar(scratchCartesianOffset, halfWidth, scratchCartesianOffset);
        ...
        function CorridorGeometry(options) {
             ...
             * @type {Number}
             */
            this.packedLength = 1 + positions.length * Cartesian2.Cartesian3.packedLength + Cartesian2.Ellipsoid.packedLength + VertexFormat.VertexFormat.packedLength + 7;
        }
