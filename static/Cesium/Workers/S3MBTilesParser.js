 ...
 */
define(['./when-a55a8a4c', './Check-bc1d37d9', './Math-edfe2d1c', './Cartesian2-f0158650', './BoundingSphere-02d3af5e', './RuntimeError-7c184ac0', './WebGLConstants-4c11ee5f', './ComponentDatatype-919a7463', './PrimitiveType-97893bc7', './FeatureDetection-bac17d71', './IndexDatatype-18a8cae6', './createTaskProcessorWorker', './BoundingRectangle-b42c500a', './Color-b1821df1', './pako_inflate-8ea163f9', './S3MCompressType-1baa0a0c'], function (when, Check, _Math, Cartesian2, BoundingSphere, RuntimeError, WebGLConstants, ComponentDatatype, PrimitiveType, FeatureDetection, IndexDatatype, createTaskProcessorWorker, BoundingRectangle, Color, pako_inflate, S3MCompressType) { 'use strict';
    ...
    function decodeIndexArray(dracoGeometry, dracoDecoder) {
        ...
        if (indexArray instanceof Uint32Array) {
            return IndexDatatype.IndexDatatype.UNSIGNED_INT;
        }
    ...
    function decodeAllAttributes(dracoGeometry, dracoDecoder, vertexPackage, vertexUniqueIDs){
        ...
        if(when.defined(vertexUniqueIDs.posUniqueID) && vertexUniqueIDs.posUniqueID >= 0){
            ...
            vertexPackage.minVerticesValue = new BoundingSphere.Cartesian4(minValuesArray[0], minValuesArray[1], minValuesArray[2], 1.0);
    ...
    S3MDracoDecode.dracoDecodeMesh = function(dracoLib, dataBuffer, byteLength, vertexPackage, indexPackage, vertexUniqueIDs){
        ...
        decodeIndexArray(dracoGeometry, dracoDecoder);
