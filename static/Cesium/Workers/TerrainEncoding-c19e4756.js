 ...
 */
define(['exports', './when-a55a8a4c', './Check-bc1d37d9', './Math-edfe2d1c', './Cartesian2-f0158650', './BoundingSphere-02d3af5e', './ComponentDatatype-919a7463', './AttributeCompression-e0c793ea'], function (exports, when, Check, _Math, Cartesian2, BoundingSphere, ComponentDatatype, AttributeCompression) { 'use strict';
    ...
    function TerrainEncoding(axisAlignedBoundingBox, minimumHeight, maximumHeight, fromENU, hasVertexNormals, hasWebMercatorT) {
        ...
        if (when.defined(axisAlignedBoundingBox) && when.defined(minimumHeight) && when.defined(maximumHeight) && when.defined(fromENU)) {
            ...
            BoundingSphere.Matrix4.setTranslation(matrix, Cartesian2.Cartesian3.ZERO, matrix);
