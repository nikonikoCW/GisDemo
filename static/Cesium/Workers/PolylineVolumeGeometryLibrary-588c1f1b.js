 ...
 */
define(['exports', './Math-edfe2d1c', './Cartesian2-f0158650', './BoundingSphere-02d3af5e', './Transforms-a6232c91', './EllipsoidTangentPlane-0da38d24', './PolylinePipeline-69e6af68'], function (exports, _Math, Cartesian2, BoundingSphere, Transforms, EllipsoidTangentPlane, PolylinePipeline) { 'use strict';
    ...
    var scratch2Array = [new Cartesian2.Cartesian3(), new Cartesian2.Cartesian3()];
        ...
        var finalPosScratch = new BoundingSphere.Cartesian4();
        ...
        function computeRoundCorner(pivot, startPoint, endPoint, cornerType, leftIsOutside, ellipsoid, finalPositions, shape, height, duplicatePoints) {
            ...
            var m;
            if (leftIsOutside) {
                m = BoundingSphere.Matrix3.fromQuaternion(Transforms.Quaternion.fromAxisAngle(Cartesian2.Cartesian3.negate(pivot, scratch1), angle / (granularity + 1), quaterion), rotMatrix);
            } else {
