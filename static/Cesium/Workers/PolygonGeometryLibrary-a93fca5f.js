 ...
 */
define(['exports', './when-a55a8a4c', './Math-edfe2d1c', './Cartesian2-f0158650', './BoundingSphere-02d3af5e', './ComponentDatatype-919a7463', './GeometryAttribute-de0e4f68', './PrimitiveType-97893bc7', './Transforms-a6232c91', './GeometryAttributes-1c7ce91d', './GeometryPipeline-ac3328f3', './IndexDatatype-18a8cae6', './arrayRemoveDuplicates-aafa59fd', './ArcType-66bc286a', './EllipsoidRhumbLine-ff66f54b', './PolygonPipeline-c1e5a14e'], function (exports, when, _Math, Cartesian2, BoundingSphere, ComponentDatatype, GeometryAttribute, PrimitiveType, Transforms, GeometryAttributes, GeometryPipeline, IndexDatatype, arrayRemoveDuplicates, ArcType, EllipsoidRhumbLine, PolygonPipeline) { 'use strict';
    ...
    /**
        ...
        PolygonGeometryLibrary.computeWallGeometry = function(positions, ellipsoid, granularity, perPositionHeight, arcType) {
            ...
            for (i = 0; i < length; i++) {
                ...
                if (Cartesian2.Cartesian3.equalsEpsilon(p1, p2, _Math.CesiumMath.EPSILON14)) {
                    continue;
                }
