 ...
 */
define(['exports', './when-a55a8a4c', './Check-bc1d37d9', './Math-edfe2d1c', './Cartesian2-f0158650', './BoundingSphere-02d3af5e', './ComponentDatatype-919a7463', './GeometryAttribute-de0e4f68', './PrimitiveType-97893bc7', './AttributeCompression-e0c793ea', './EncodedCartesian3-d5c0d180', './IndexDatatype-18a8cae6', './IntersectionTests-b4e5ec49', './Plane-a550aa8c'], function (exports, when, Check, _Math, Cartesian2, BoundingSphere, ComponentDatatype, GeometryAttribute, PrimitiveType, AttributeCompression, EncodedCartesian3, IndexDatatype, IntersectionTests, Plane) { 'use strict';
    ...
    var interpolateAndPackCartesian4 = generateBarycentricInterpolateFunction(BoundingSphere.Cartesian4, 4);
    ...
    var cartesian3Scratch7 = new Cartesian2.Cartesian3();

    var cartesian4Scratch0 = new BoundingSphere.Cartesian4();
        ...
        for (i = 0; i < length; i += 4) {
            ...
            if (when.defined(intersection)) {
                ...
                if (when.defined(colors)) {
                    var c0 = BoundingSphere.Cartesian4.fromArray(colors, i0 * 4, cartesian4Scratch0);
                    var c2 = BoundingSphere.Cartesian4.fromArray(colors, i2 * 4, cartesian4Scratch0);
                ...
                if (when.defined(dist)) {
                    var d0 = Cartesian2.Cartesian3.fromArray(dist, i0 * 3, cartesian3Scratch7);
                    var d1 = Cartesian2.Cartesian3.fromArray(dist, i2 * 3, cartesian3Scratch7);
