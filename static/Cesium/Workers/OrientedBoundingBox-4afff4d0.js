 ...
 */
define(['exports', './when-a55a8a4c', './Check-bc1d37d9', './Math-edfe2d1c', './Cartesian2-f0158650', './BoundingSphere-02d3af5e', './Plane-a550aa8c', './EllipsoidTangentPlane-0da38d24'], function (exports, when, Check, _Math, Cartesian2, BoundingSphere, Plane, EllipsoidTangentPlane) { 'use strict';
    ...
    /**
         ...
         * @type {Number}
         */
        OrientedBoundingBox.packedLength = Cartesian2.Cartesian3.packedLength + BoundingSphere.Matrix3.packedLength;
        ...
        OrientedBoundingBox.pack = function(value, array, startingIndex) {
            ...
            BoundingSphere.Matrix3.pack(value.halfAxes, array, startingIndex + Cartesian2.Cartesian3.packedLength);
        ...
        OrientedBoundingBox.unpack = function(array, startingIndex, result) {
            ...
            BoundingSphere.Matrix3.unpack(array, startingIndex + Cartesian2.Cartesian3.packedLength, result.halfAxes);
            return result;
        };
        ...
        OrientedBoundingBox.fromRectangle = function(rectangle, minimumHeight, maximumHeight, ellipsoid, result) {
            ...
            var horizonCartesian = Cartesian2.Cartesian3.fromRadians(centerLongitude + _Math.CesiumMath.PI_OVER_TWO, latitudeNearestToEquator, maximumHeight, ellipsoid, scratchHorizonCartesian);
