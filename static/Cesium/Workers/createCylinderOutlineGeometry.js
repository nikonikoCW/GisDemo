 ...
 */
define(['./when-a55a8a4c', './Check-bc1d37d9', './GeometryOffsetAttribute-c9accdb9', './Math-edfe2d1c', './Cartesian2-f0158650', './BoundingSphere-02d3af5e', './RuntimeError-7c184ac0', './WebGLConstants-4c11ee5f', './ComponentDatatype-919a7463', './GeometryAttribute-de0e4f68', './PrimitiveType-97893bc7', './FeatureDetection-bac17d71', './Transforms-a6232c91', './GeometryAttributes-1c7ce91d', './IndexDatatype-18a8cae6', './CylinderGeometryLibrary-08369efb'], function (when, Check, GeometryOffsetAttribute, _Math, Cartesian2, BoundingSphere, RuntimeError, WebGLConstants, ComponentDatatype, GeometryAttribute, PrimitiveType, FeatureDetection, Transforms, GeometryAttributes, IndexDatatype, CylinderGeometryLibrary) { 'use strict';
    ...
    var radiusScratch = new Cartesian2.Cartesian2();
        ...
        CylinderOutlineGeometry.createGeometry = function(cylinderGeometry) {
            ...
            var boundingSphere = new BoundingSphere.BoundingSphere(Cartesian2.Cartesian3.ZERO, Cartesian2.Cartesian2.magnitude(radiusScratch));
